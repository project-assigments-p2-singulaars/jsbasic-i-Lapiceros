...
let coleccion = ['pera', 'manzana', 4, 'uva'];

console.log(nombre, edad, boolean, x, y, object, coleccion);
...
let comparacion = num3 > num4;//Realiza la operación de comparación que consideres para que el resultado en consola sea true
...
let result = num5 === num3AsString;//Realiza la operación de comparación que consideres entre las dos variables dadas, para que el resultado en consola sea false sin usar el comparador de desigualdad
console.log(result) 


//Ejercicio 13: completa el ejercicio

let result2 = num5 == num3AsString;//Realiza la operación de comparación que consideres con las dos variables del ejercicio anterior para que el resultado en consola sea true.
console.log(result2)
...
//Escribe tu código aquí
let miNombre = 'Escurridizo';
let apellido = 'Jonhson'
